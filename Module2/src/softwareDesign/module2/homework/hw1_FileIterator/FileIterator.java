...
public class FileIterator implements Iterator<String>, AutoCloseable {
    ...
    public FileIterator(String filePath) throws IOException {
        ...
        try {
            ...
            throw new UncheckedIOException("There has been a problem while trying to read file.", ioException);
        }
    }
    ...
    public String next() {
        try {
            ...
            throw new UncheckedIOException("There has been an error while reading the file.\n" +
                    "More information: " +
                    Arrays.toString(ioException.getStackTrace()), ioException);
        }
    }
